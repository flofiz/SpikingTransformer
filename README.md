...
```bash
torchrun --nproc_per_node=2 train_spikeformer.py --use_wandb --wandb_project spikeformer-ocr --num_steps 4 --in_channels 1 --batch_size 80 --use_mssa --use_curriculum --compile
```
